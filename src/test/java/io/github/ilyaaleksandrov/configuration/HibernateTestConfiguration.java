package io.github.ilyaaleksandrov.configuration;
...
@ComponentScan({ "io.github.ilyaaleksandrov.dao" })
public class HibernateTestConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "io.github.ilyaaleksandrov.model" });
